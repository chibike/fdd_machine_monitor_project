...
from basic_app.views import IndexView, ChangePasswordView, AdminView, NewUserView, AuthView, DeleteUserView, EditUserView, dummy_function, NewDeviceView, DeleteDeviceView, DashboardView
...
urlpatterns = [
    ...
    path('edit_device/<str:id>', dummy_function, name='edit_device'),
    path('edit_device', dummy_function, name='new_device'),
